        ...
        if not fmp.is_configured:
            ...
            if not _fs_inc and not _fs_bs and not _fs_cf:
                ...
                _cash_flow_items = [
                    ...
                    ("investmentsInPropertyPlantAndEquipment",  "Capital Expenditure (PP&E)",   False),
                    ...
                    ("otherInvestingActivities",                "Other Investing Activities",   False),
                    ("netCashProvidedByInvestingActivities",    "Cash from Investing",          True),
                    ("netDebtIssuance",                        "Net Debt Issuance",            False),
                    ("longTermNetDebtIssuance",                "  Long-Term Debt (Net)",       False),
                    ("shortTermNetDebtIssuance",               "  Short-Term Debt (Net)",      False),
                    ("commonStockRepurchased",                 "Share Repurchases",            False),
                    ("commonStockIssuance",                    "Share Issuance",               False),
                    ("dividendsPaid",                          "Dividends Paid",               False),
                    ("commonDividendsPaid",                    "  Common Dividends",           False),
                    ("preferredDividendsPaid",                 "  Preferred Dividends",        False),
                    ("otherFinancingActivities",               "Other Financing Activities",   False),
